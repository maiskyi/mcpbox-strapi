...
export interface ApiFeatureFeature extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Dashboard: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    ReleaseDate: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2025-09-01'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServerCategoryServerCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::server-category.server-category'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Slug: Schema.Attribute.UID<'Title'> & Schema.Attribute.Required;
...
export interface ApiServerServer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    GitHubLanguage: Schema.Attribute.String;
    GitHubLicense: Schema.Attribute.String;
    GitHubOwner: Schema.Attribute.String & Schema.Attribute.Required;
    GitHubPublishedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
...
export interface ApiSocialSocial extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    X: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
